...
public class TC006 extends Base_Test {
	@Test
	public void testSellerRatingDisplayed() throws InterruptedException {
		...
		WebElement Rating = driver.findElement(By.xpath("//div[@id=\"sellerName\"]"));
		System.out.println("TC006--" + Rating.getText());
